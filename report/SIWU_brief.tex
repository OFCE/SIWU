...
\fancyfoot[LO, LE]{\small{HICP release 19 october 2022}}
...
\hypersetup{
  ...
  pdfauthor={François Geerolf, Xavier Timbeau, Guillaume Allègre},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, arc=.35mm, breakable, rightrule=.15mm, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, leftrule=.75mm]
