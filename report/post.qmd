...
```{r, fig.asp = 1}
#| label: fig-quintile
#| fig_scap: "Impact par quintile"
#| fig-cap: "Hausse des consommations d'une sélection de produits depuis février 2022 jusqu'à avril 2022 en % du revenu du quintinle. L'impact est la somme de l'impact chaque mois divisé par la somme des revenus mensuels sur la même période. Les produits sont les huiles et matières grasses, céréales, combustibles pour le transport et le chauffage (COICOP CP0111, CP0115, CP0451, CP0452, CP0453, CP0454, CP0722)\nSource: Eurostat HICP et revenus par quintile"
  ...
  data |> 
    ...
    labs(title = NULL,
         ...
         caption = str_c("Note: L'impact sur chaque quintile est en % du revenu du quintinle  pour chque catégorie de produit (88 produits COICOP).",
                         "L'impact est la somme de l'impact chaque mois divisé par la somme des revenus mensuels.",
