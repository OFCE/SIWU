...
of Europeans' purchasing power in the short run. We use the latest data given to us by eurostat, last
updated on `r format(last_update_data, '%d %B, %Y')`.
...
-   We don't take into account expected increase in future prices due to known indexation mechanisms.
...
-   We don't take into account increases in wages or other components of income that could increase in
    the future due to price increase. Some of those indexations are explicit in private contracts or
